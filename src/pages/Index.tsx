...
const DEFAULT_ELEMENTS: TextElement[] = [
  { key: "name", label: "Recipient Name", x: 400, y: 280, fontSize: 36, color: "#000000", enabled: true },
  { key: "event", label: "Event / Course", x: 400, y: 230, fontSize: 20, color: "#003366", enabled: true },
  { key: "date", label: "Date", x: 400, y: 400, fontSize: 16, color: "#666666", enabled: true },
  { key: "id", label: "Certificate ID", x: 400, y: 440, fontSize: 12, color: "#999999", enabled: false },
];
