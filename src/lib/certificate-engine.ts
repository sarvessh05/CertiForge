...
export async function generateCertificates(options: GenerateOptions): Promise<Blob> {
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    pdfDoc.setTitle("Certificate generated by CertiForge");
    pdfDoc.setAuthor("Sarvesh Ghotekar");
    pdfDoc.setCreator("CertiForge by Sarvesh Ghotekar");
    pdfDoc.setProducer("CertiForge - Bulk Certificate Automation");
    pdfDoc.setSubject("Certificate of Achievement");
    pdfDoc.setKeywords(["certificate", "achievement", "certiforge", "sarvesh ghotekar"]);
